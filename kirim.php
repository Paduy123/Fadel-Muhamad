...
try {
    ...
    $mail->Username   = 'fadel.prakduy94@gmail.com';                     //SMTP username
    $mail->Password   = 'ubqi upqz wogn csvv';                               //SMTP password
    $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS

    //Recipients
    $mail->setFrom('fadel.prakduy94@gmail.com', 'Saran GFood');
    $mail->addAddress('fadel.prakduy94@gmail.com', 'GFood');     //Add a recipient
